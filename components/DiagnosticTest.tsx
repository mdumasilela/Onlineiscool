        ...
        <div className="bg-slate-800 rounded-2xl shadow-2xl p-8 min-h-[400px] flex flex-col justify-center border border-slate-700">
          {currentStep === 0 && (
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-300">This test covers Algebra, Functions, Trigonometry, Geometry, and Probability based on both <span className="text-cyan-400 font-bold">GDE & IEB</span> Grade 10-12 syllabuses.</p>
              <button 
                onClick={startTest}
