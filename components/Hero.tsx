    ...
    <section id="home" className="py-24 md:py-32 text-center bg-slate-800/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/30 px-4 py-2 rounded-full mb-8 animate-bounce">
            ...
            <span className="text-yellow-500 text-sm font-bold uppercase tracking-widest">50% OFF Back to School Offer - Ends 1 March 2026</span>
        </div>
        <h1 className="text-4xl md:text-7xl font-bold text-white leading-tight mb-6">
          Unlock Your Math Potential. <br />
          <span className="text-cyan-400">Ace Your GDE & IEB Exams.</span>
        </h1>
        <p className="text-lg md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          Specializing in both <span className="text-cyan-400">GDE and IEB</span> curricula.
        </p>
