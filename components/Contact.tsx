    ...
    <section id="contact" className="py-20 md:py-28 bg-slate-800/50">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2">Fill out the form to lock in your special rate before 28 February 2026.</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="bg-slate-800 p-8 rounded-2xl shadow-2xl space-y-6 border border-slate-700">
                ...
                <div>
                    ...
                    <p className="text-center text-gray-500 text-xs mt-4">
                        By submitting, you agree to our terms. Offer valid for signups before 28 February 2026.
                    </p>
                </div>
            </form>
        )}
